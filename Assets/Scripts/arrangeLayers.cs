...
public class arrangeLayers : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Transform smellCloudB = transform.Find("SmellCloudB");
        ...
        Transform oilySprite = transform.Find("OilySprite");
        ...
        if (smellCloudB != null)
        {
            smellCloudB.GetComponent<SpriteRenderer>().sortingOrder = (GetComponent<SpriteRenderer>().sortingOrder) - 10;
        }
        if (oilySprite != null)
        {
            oilySprite.GetComponent<SpriteRenderer>().sortingOrder = (GetComponent<SpriteRenderer>().sortingOrder) + 10;
        }
